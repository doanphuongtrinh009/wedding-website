...
const packageKeys = ["halfDay", "fullDay", "weddingDay"] as const;
...
const galleryItems = [
  { key: "look1", src: "/images/bridal/hero-banner.png" },
  { key: "look2", src: "/images/products/mermaid-1.png" },
  { key: "look3", src: "/images/products/ballgown-1.png" }
] as const;

export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations("PhotoServicePage");
...
export default async function PhotoServicePage() {
  const t = await getTranslations("PhotoServicePage");

  return (
    <section className="section-shell space-y-7">
      <div className="soft-frame overflow-hidden bg-[linear-gradient(160deg,rgba(255,255,255,0.95)_0%,rgba(247,241,233,0.9)_100%)] p-6 md:p-8">
        <div className="grid gap-6 lg:grid-cols-[1fr_0.95fr] lg:items-center">
          <div className="space-y-4">
            ...
            <div className="grid gap-2 sm:grid-cols-3">
              {(["priceFrom", "serviceType", "delivery"] as const).map((stat) => (
                <div
                  key={stat}
            ...
            <div className="flex flex-col gap-2 sm:flex-row">
              ...
              >
                <Link href="/book?services=photo">{t("ctas.bookOnly")}</Link>
              </Button>
              <Button
                asChild
                variant="outline"
