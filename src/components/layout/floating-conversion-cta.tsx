...
export function FloatingConversionCta() {
  ...
  return (
    <aside className="pointer-events-none fixed inset-x-0 bottom-0 z-50 px-3 pb-[calc(env(safe-area-inset-bottom)+0.75rem)] md:inset-x-auto md:bottom-6 md:right-6 md:max-w-sm md:px-0 md:pb-0">
      <div className="bg-background/92 pointer-events-auto rounded-2xl border border-border/70 p-2 shadow-luxury backdrop-blur-sm md:hidden">
      ...
      <div className="bg-background/94 pointer-events-auto hidden w-72 space-y-2 rounded-2xl border border-border/70 p-3 shadow-luxury backdrop-blur-sm md:block">
        {!isBookingPage ? (
