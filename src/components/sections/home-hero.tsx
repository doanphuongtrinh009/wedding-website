...
export async function HomeHero() {
  ...
  return (
    <section className="section-shell relative grid gap-8 overflow-hidden pb-space-xl md:grid-cols-[1.08fr_0.92fr] md:items-end md:gap-10">
      ...
      <div className="relative z-10 space-y-6 md:space-y-7">
        ...
        <dl className="grid grid-cols-1 gap-2 pt-2 text-sm text-muted-foreground sm:grid-cols-3 sm:gap-3">
      ...
      <div className="relative z-10 space-y-4 rounded-[1.6rem] border border-border/75 bg-[linear-gradient(160deg,rgba(255,255,255,0.96)_0%,rgba(253,246,240,0.92)_100%)] p-6 shadow-luxury md:p-8">
        <p className="editorial-kicker">{t("clientExperience")}</p>
        <h2 className="text-[2rem] md:text-[2.9rem]">{t("clientHeading")}</h2>
