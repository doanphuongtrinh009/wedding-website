...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl border text-[0.8rem] font-semibold uppercase tracking-[0.11em] transition-[transform,opacity,box-shadow] duration-300 ease-out motion-safe:will-change-transform motion-safe:hover:-translate-y-0.5 motion-safe:hover:scale-[1.015] motion-safe:active:translate-y-px motion-safe:active:scale-[0.992] disabled:pointer-events-none disabled:opacity-50 outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
  {
    variants: {
      variant: {
        default:
        ...
        secondary:
          "border-secondary bg-secondary/95 text-secondary-foreground shadow-sm hover:border-brand-rose/60 hover:bg-brand-blush/55 hover:shadow-editorial",
        outline:
          "border-border/85 bg-background/70 text-foreground shadow-sm backdrop-blur hover:bg-card/90 hover:shadow-editorial",
        ghost:
